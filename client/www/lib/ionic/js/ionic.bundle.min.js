...
!function () {
    ...
    function o(t) {
        if (!t.isIonicTap && !_(t)) {
            if (k)return t.stopPropagation(), ionic.tap.isTextInput(t.target) && $ === t.target || /^(select|option)$/i.test(t.target.tagName) || t.preventDefault(), !1;
            F = !1, X = ionic.tap.pointerCoord(t), e("mousemove"), ionic.activator.start(t)
        }
    }

    function r(n) {
        return k ? (n.stopPropagation(), n.preventDefault(), !1) : _(n) || /^(select|option)$/i.test(n.target.tagName) ? !1 : (v(n) || t(n), e("mousemove", !1), ionic.activator.end(), void(F = !1))
    }
    ...
    function a(t) {
        if (!_(t) && (F = !1, d(), X = ionic.tap.pointerCoord(t), e(U), ionic.activator.start(t), ionic.Platform.isIOS() && ionic.tap.isLabelWithTextInput(t.target))) {
            var n = E(T(t.target));
    ...
    function l(e) {
        _(e) || (d(), v(e) || (t(e), /^(select|option)$/i.test(e.target.tagName) && e.preventDefault()), $ = e.target, u())
    }
    ...
    function d() {
        k = !0, clearTimeout(Y), Y = setTimeout(function () {
            k = !1
        }, 600)
    }
    ...
    function h(e) {
        W = null;
        var t = !1;
        "SELECT" == e.tagName ? (n("mousedown", e, 0, 0), e.focus && e.focus(), t = !0) : g() === e ? t = !0 : /^(input|textarea)$/i.test(e.tagName) || e.isContentEditable ? (t = !0, e.focus && e.focus(), e.value = e.value, k && (W = e)) : f(), t && (g(e), ionic.trigger("ionic.focusin", {target: e}, !0))
    }
    ...
    function p(e) {
        k && ionic.tap.isTextInput(g()) && ionic.tap.isTextInput(W) && W !== e.target && (W.focus(), W = null), ionic.scroll.isScrolling = !1
    }
    ...
    function v(e) {
        if (!e || 1 !== e.target.nodeType || !X || 0 === X.x && 0 === X.y)return !1;
        ...
        return Math.abs(X.x - t.x) > i || Math.abs(X.y - t.y) > i
    }
    ...
    function S() {
        G() ? (window.addEventListener("native.keyboardshow", w), window.addEventListener("native.keyboardhide", L), window.addEventListener("native.showkeyboard", w), window.addEventListener("native.hidekeyboard", L)) : document.body.addEventListener("focusout", L), document.body.addEventListener("ionic.focusin", b), document.body.addEventListener("focusin", b), document.body.addEventListener("orientationchange", I), window.navigator.msPointerEnabled ? document.removeEventListener("MSPointerDown", S) : document.removeEventListener("touchstart", S)
    }
    ...
    function b(e) {
        e.target && !e.target.readOnly && ionic.tap.isKeyboardElement(e.target) && P(e.target) && (document.addEventListener("keydown", M, !1), document.body.scrollTop = 0, document.body.querySelector(".scroll-content").scrollTop = 0, K = e.target, y(e))
    }
        ...
        clearTimeout(J), clearTimeout(j), J = setTimeout(function () {
            if (!(tt + 350 > Date.now())) {
                ...
                Q = setInterval(function () {
                    t = C(), i > 10 && (clearInterval(Q), t = 275), t && (clearInterval(Q), D(e.target, n.top, n.bottom, et, t)), i++
                }, 100)
            }
        }, 32)
    }
    ...
    function D(e, t, n, i, o) {
        ...
        return r.hasPlugin = G(), r.contentHeight = i - o, r.isElementUnderKeyboard = r.elementBottom > r.contentHeight, ionic.keyboard.isOpen = !0, K = e, ionic.trigger("scrollChildIntoView", r, !0), ionic.requestAnimationFrame(function () {
            document.body.classList.add(nt)
        }), window.navigator.msPointerEnabled ? document.addEventListener("MSPointerMove", N, !1) : document.addEventListener("touchmove", N, !1), r
    }
    ...
    function O() {
        ...
        for (e = 0; e < document.head.children.length; e++)if ("viewport" == document.head.children[e].name) {
            ot = document.head.children[e];
            break
        }
        if (ot) {
            var t, n = ot.content.toLowerCase().replace(/\s+/g, "").split(",");
            for (e = 0; e < n.length; e++)n[e] && (t = n[e].split("="), rt[t[0]] = t.length > 1 ? t[1] : "_");
            V()
        }
    }

    function V() {
        var e = rt.width, t = rt.height, n = ionic.Platform, i = n.version(), o = "device-width", r = "device-height", s = ionic.viewport.orientation();
        delete rt.height, rt.width = o, n.isIPad() ? i > 7 ? delete rt.width : n.isWebView() ? 90 == s ? rt.height = "0" : 7 == i && (rt.height = r) : 7 > i && (rt.height = "0") : n.isIOS() && (n.isWebView() ? i > 7 ? delete rt.width : 7 > i ? t && (rt.height = "0") : 7 == i && (rt.height = r) : 7 > i && t && (rt.height = "0")), (e !== rt.width || t !== rt.height) && R()
    }

    function R() {
        var e, t = [];
        for (e in rt)rt[e] && t.push(e + ("_" == rt[e] ? "" : "=" + rt[e]));
        ot.content = t.join(", ")
    }

    window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.0.0-rc.2", function (e) {
    ...
    var z, H, k, Y, F, X, W, $, U = "touchmove", q = 12, B = 50, Z = {
        click: i,
        mousedown: o,
        mouseup: r,
        mousemove: s,
    ...
    ionic.tap = {
        register: function (t) {
            return z = t, e("click", !0, !0), e("mouseup"), e("mousedown"), window.navigator.pointerEnabled ? (e("pointerdown"), e("pointerup"), e("pointcancel"), U = "pointermove") : window.navigator.msPointerEnabled ? (e("MSPointerDown"), e("MSPointerUp"), e("MSPointerCancel"), U = "MSPointerMove") : (e("touchstart"), e("touchend"), e("touchcancel")), e("focusin"), e("focusout"), function () {
                for (var t in Z)e(t, !1);
                z = null, H = null, k = !1, F = !1, X = null
            }
    ...
    var K, j, J, Q, et = A(), tt = 0, nt = "keyboard-open", it = "scroll";
    ionic.keyboard = {
        isOpen: !1, height: null, landscape: !1, hide: function () {
            ...
            }), window.navigator.msPointerEnabled ? document.removeEventListener("MSPointerMove", N) : document.removeEventListener("touchmove", N), document.removeEventListener("keydown", M), G() && cordova.plugins.Keyboard.close()
        }, show: function () {
            G() && cordova.plugins.Keyboard.show()
        }
        ...
        st.effect.Animate = {
            requestAnimationFrame: function () {
                ...
                var v = function (r) {
                    ...
                    l && (h = (g - d) / l, h > 1 && (h = 1));
                    var S = c ? c(h) : h;
                    e(S, g, m) !== !1 && 1 !== h || !m ? m && (_ = g, st.effect.Animate.requestAnimationFrame(v, u)) : (o[p] = null, a && a(n - f / ((g - d) / i), p, 1 === h || null == l))
                };
                return o[p] = !0, st.effect.Animate.requestAnimationFrame(v, u), p
            }
        }
    }(this);
    !function (e) {
        ...
        e.views.Scroll = e.views.View.inherit({
                ...
                if (n.scrollChildIntoView = function (t) {
                        ...
                        if (!n.isScrolledIntoView) {
                            if (e.Platform.isIOS() || e.Platform.isFullScreen) {
                                ...
                                var r = t.detail.viewportHeight - o, s = Math.max(0, t.detail.keyboardHeight - r);
                        ...
                        if (t.detail.isElementUnderKeyboard) {
                            ...
                            a = e.Platform.isAndroid() && !e.Platform.isFullScreen ? e.Platform.version() < 4.4 ? 500 : 350 : 80, e.scroll.isScrolling = !0, setTimeout(function () {
                                var r = .5 * i.clientHeight;
                                o = i.getBoundingClientRect().bottom;
                                var s = t.detail.elementTop - o, a = s + r;
                    ...
                    }, n.touchMove = function (o) {
                        if (!(n.options.freeze || !n.__isDown || !n.__isDown && o.defaultPrevented || "TEXTAREA" === o.target.tagName && o.target.parentElement.querySelector(":focus"))) {
                            if (!n.__hasStarted && (e.tap.containsOrIsTextInput(o.target) || "SELECT" === o.target.tagName))return n.__hasStarted = !0, n.doTouchStart(t(o), o.timeStamp), void o.preventDefault();
                            if (n.startCoordinates) {
                                var r = e.tap.pointerCoord(o);
                                n.__isSelectable && e.tap.isTextInput(o.target) && Math.abs(n.startCoordinates.x - r.x) > 20 && (n.__enableScrollY = !1, n.__isSelectable = !0), n.__enableScrollY && Math.abs(n.startCoordinates.y - r.y) > 10 && (n.__isSelectable = !1, e.tap.cloneFocusedInput(i, n))
                            }
                            n.doTouchMove(t(o), o.timeStamp, o.scale), n.__isDown = !0
                        }
                    ...
                    n.mouseDown = function (i) {
                        e.tap.ignoreScrollStart(i) || "SELECT" === i.target.tagName || (n.doTouchStart(t(i), i.timeStamp), e.tap.isTextInput(i.target) || i.preventDefault(), o = !0)
                    }, n.mouseMove = function (e) {
                        n.options.freeze || !o || !o && e.defaultPrevented || (n.doTouchMove(t(e), e.timeStamp), o = !0)
                    }, n.mouseMoveBubble = function (e) {
                        o && n.options.preventDefault && e.preventDefault()
                    }, n.mouseUp = function (e) {
                        o && (n.doTouchEnd(e, e.timeStamp), o = !1)
            ...
            zoomTo: function (e, t, n, i) {
                ...
                o.__isDecelerating && (st.effect.Animate.stop(o.__isDecelerating), o.__isDecelerating = !1);
                var r = o.__zoomLevel;
            ...
            scrollTo: function (e, t, n, i, o) {
                var r = this;
                if (r.__isDecelerating && (st.effect.Animate.stop(r.__isDecelerating), r.__isDecelerating = !1), null != i && i !== r.__zoomLevel) {
            ...
            __publish: function (e, t, o, r, s) {
                ...
                if (l && (st.effect.Animate.stop(l), a.__isAnimating = !1), r && a.options.animating) {
            ...
            __startDeceleration: function () {
                ...
                e.__isDecelerating = st.effect.Animate.start(r, s, a)
            },
                ...
                function r(t, n) {
                    if (S != t) {
                        if (f.transitions) {
                            ...
                            t = o(t), s(S, v * i, n || w), s(t, 0, n || w), e.continuous && s(o(t - i), -(v * i), 0)
                        } else t = o(t), l(S * -v, t * -v, n || w);
                        ...
                        handleEvent: function (n) {
                            ...
                            if (!(t.touches.length > 1 || t.scale && 1 !== t.scale || d.slideIsDisabled)) {
                                ...
                                x = {
                                    x: n.pageX - L.x,
                                    y: n.pageY - L.y
                                }, "undefined" == typeof y && (y = !!(y || Math.abs(x.x) < Math.abs(x.y))), y || (t.preventDefault(), u(), e.continuous ? (a(o(S - 1), x.x + g[o(S - 1)], 0), a(S, x.x + g[S], 0), a(o(S + 1), x.x + g[o(S + 1)], 0)) : (x.x = x.x / (!S && x.x > 0 || S == m.length - 1 && x.x < 0 ? Math.abs(x.x) / v + 1 : 1), a(S - 1, x.x + g[S - 1], 0), a(S, x.x + g[S], 0), a(S + 1, x.x + g[S + 1], 0)))
                            }
                        }, end: function () {
                            var t = +new Date - L.time, n = Number(t) < 250 && Math.abs(x.x) > 20 || Math.abs(x.x) > v / 2, i = !S && x.x > 0 || S == m.length - 1 && x.x < 0;
                            e.continuous && (i = !1);
                            var r = x.x < 0;
                            y || (n && !i ? (r ? (e.continuous ? (s(o(S - 1), -v, 0), s(o(S + 2), v, 0)) : s(S - 1, -v, 0), s(S, g[S] - v, w), s(o(S + 1), g[o(S + 1)] - v, w), S = o(S + 1)) : (e.continuous ? (s(o(S + 1), v, 0), s(o(S - 2), -v, 0)) : s(S + 1, v, 0), s(S, g[S] + v, w), s(o(S - 1), g[o(S - 1)] + v, w), S = o(S - 1)), e.callback && e.callback(S, m[S])) : e.continuous ? (s(o(S - 1), -v, w), s(S, 0, w), s(o(S + 1), v, w)) : (s(S - 1, -v, w), s(S, 0, w), s(S + 1, v, w))), f.touch ? (E.removeEventListener("touchmove", M, !1), E.removeEventListener("touchend", M, !1)) : (E.removeEventListener("mousemove", M, !1), E.removeEventListener("mouseup", M, !1), document.removeEventListener("mouseup", M, !1))
...
!function () {
    function e(e, t, n, i, o, r) {
        function a(i, a, c, s, l) {
            function u() {
                M.resizeRequiresRefresh(w.__clientWidth, w.__clientHeight) && g()
            }
            ...
            function v() {
                _ || N ? (_ ? m(_, x) : x.computed = !0, N || (N = '"100%"'), m(N, A)) : x.computed = A.computed = !0
            }
            ...
            var C, T = k[1], B = k[2], I = t(B), x = {}, A = {}, V = {}, P = [], D = c.itemRenderBuffer || c.collectionBufferSize, L = angular.isDefined(D) ? parseInt(D) : E, _ = c.itemHeight || c.collectionItemHeight, N = c.itemWidth || c.collectionItemWidth, R = p(), M = d();
            ...
            r(g, 0, !1), i.$watchCollection(I, function (e) {
                ...
                i.$$postDigest(function () {
                    h().setData(P), M.dataChangeRequiresRefresh(P) && g()
                })
        ...
        return function (r) {
            ...
            function u() {
                this.getItemPrimarySize = D, this.getItemSecondarySize = _, this.getScrollValue = function () {
                    return Math.max(0, Math.min(B.__scrollTop - q, B.__maxScrollTop - q - W))
                }, this.refreshDirection = function () {
                    this.scrollPrimarySize = B.__clientHeight, this.scrollSecondarySize = B.__clientWidth, this.estimatedPrimarySize = g, this.estimatedSecondarySize = m, this.estimatedItemsAcross = R && Math.floor(B.__clientWidth / m) || 1
                }
            }

            function d() {
                this.getItemPrimarySize = _, this.getItemSecondarySize = D, this.getScrollValue = function () {
                    return Math.max(0, Math.min(B.__scrollLeft - q, B.__maxScrollLeft - q - W))
                }, this.refreshDirection = function () {
                    this.scrollPrimarySize = B.__clientWidth, this.scrollSecondarySize = B.__clientHeight, this.estimatedPrimarySize = m, this.estimatedSecondarySize = g, this.estimatedItemsAcross = R && Math.floor(B.__clientHeight / g) || 1
                }
            }
            ...
            function p() {
                this.getContentSize = function () {
                    return this.getEstimatedPrimaryPos(E.length - 1) + this.estimatedPrimarySize + q + W
                };
                var e = {};
                this.getDimensions = function (t) {
                    ...
                    F = Math.max(0, this.getEstimatedIndex(e)), X = Math.min(E.length - 1, this.getEstimatedIndex(t) + this.estimatedItemsAcross - 1), G = Math.max(0, this.getEstimatedPrimaryPos(F)), Y = this.getEstimatedPrimaryPos(X) + this.estimatedPrimarySize
                }
            }
            ...
            function v() {
                ...
                var n, r = this, a = ionic.debounce(et, 25, !0), c = R ? t : e, s = [];
                this.getContentSize = function () {
                    var e = s[n] || o;
                    return (e.primaryPos + e.primarySize || 0) + this.getEstimatedPrimaryPos(E.length - n - 1) + q + W
                ...
                this.updateRenderRange = function (e, t) {
                    ...
                    F = Math.min(Math.max(0, n), E.length - 1), G = -1 !== F ? this.getDimensions(F).primaryPos : -1;
                    var r;
                    for (n = F + 1, i = E.length; i > n; n++)if ((o = this.getDimensions(n)) && o.primaryPos + o.primarySize > t) {
                        if (R)for (r = o; i - 1 > n && (o = this.getDimensions(n + 1)).primaryPos === r.primaryPos;)n++;
                        break
                    }
                    X = Math.min(n, E.length - 1), Y = -1 !== X ? (o = this.getDimensions(X)).primaryPos + o.primarySize : -1, u = e, l = F
                }
            }
            ...
            }, N = !!B.options.scrollingY, R = N ? S.dynamic || S.value !== B.__clientWidth : y.dynamic || y.value !== B.__clientHeight, M = !y.dynamic && !S.dynamic, H = "PRIMARY", z = "SECONDARY", O = N ? "translate3d(SECONDARYpx,PRIMARYpx,0)" : "translate3d(PRIMARYpx,SECONDARYpx,0)", U = N ? "height: PRIMARYpx; width: SECONDARYpx;" : "height: SECONDARYpx; width: PRIMARYpx;", q = 0, W = 0, F = -1, X = -1, Y = -1, G = -1, j = [], Z = [], K = [], J = {}, Q = 0, et = N ? function () {
                B.setDimensions(null, null, null, tt.getContentSize(), !0)
            } : function () {
                B.setDimensions(null, null, tt.getContentSize(), null, !0)
            }, tt = N ? new u : new d;
            (R ? f : h).call(tt), (M ? p : v).call(tt);
            var nt = N ? "getContentHeight" : "getContentWidth", it = B.options[nt];
            B.options[nt] = angular.bind(tt, tt.getContentSize), B.__$callback = B.__callback, B.__callback = function (e, t, n, i) {
                ...
                (-1 === F || o + tt.scrollPrimarySize > Y || G > o) && c(), B.__$callback(e, t, n, i)
            };
            var ot = !1, rt = !1;
            this.refreshLayout = function () {
                ...
                W = (parseInt(e[N ? "height" : "width"]) || 0) + (n && parseInt(n[N ? "marginTop" : "marginLeft"]) || 0) + (i && parseInt(i[N ? "marginBottom" : "marginRight"]) || 0), q = 0;
                var o = w;
                do q += o[N ? "offsetTop" : "offsetLeft"]; while (ionic.DomUtil.contains(B.__content, o = o.offsetParent));
                var r = w.previousElementSibling, c = r ? t.getComputedStyle(r) : {}, s = parseInt(c[N ? "marginBottom" : "marginRight"] || 0);
    ...
    l.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", function (e, t, n, i, o, r, a) {
        ...
        return L.prototype.initialize = function (e) {
            ...
            register: function (e, t) {
                var i, a, l, u = v(), m = f(e), L = D.currentView, _ = D.backView, N = D.forwardView, R = null, M = null, H = V, z = m.historyId, O = n.url();
                if ($ !== u && ($ = u, P++), y)R = y.viewId, M = y.action, H = y.direction, y = null; else if (_ && _.stateId === u)R = _.viewId, z = _.historyId, M = C, _.historyId === L.historyId ? H = B : L && (H = A, i = d(_.historyId), i && i.parentHistoryId === L.historyId ? H = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = E))); else if (N && N.stateId === u)R = N.viewId, z = N.historyId, M = T, N.historyId === L.historyId ? H = I : L && (H = A, L.historyId === m.parentHistoryId ? H = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = E))), i = h(e), N.historyId && i.scope && (i.scope.$historyId = N.historyId, z = N.historyId); else if (L && L.historyId !== z && m.cursor > -1 && m.stack.length > 0 && m.cursor < m.stack.length && m.stack[m.cursor].stateId === u) {
                    var U = m.stack[m.cursor];
                    R = U.viewId, z = U.historyId, M = C, H = E, i = d(L.historyId), i && i.parentHistoryId === z ? H = A : (i = d(z), i && i.parentHistoryId === L.historyId && (H = x)), i = c(U.backViewId), i && U.historyId !== i.historyId && (m.stack[m.cursor].backViewId = L.viewId)
                } else {
                    ...
                    if (R = ionic.Utils.nextUid(), L) {
                        if (L.forwardViewId = R, M = k, N && L.stateId !== N.stateId && L.historyId === N.historyId && (i = d(N.historyId))) {
                    ...
                    2 > P && (H = V), D.views[R] = this.createView({
                        viewId: R,
                        ...
                        stateParams: g(),
                        url: O
                    }), m.stack.push(D.views[R])
                }
                if (o.cancel(b), w) {
                    if (w.disableAnimate && (H = V), w.disableBack && (D.views[R].backViewId = null), w.historyRoot) {
                        for (a = 0; a < m.stack.length; a++)m.stack[a].viewId === R ? (m.stack[a].index = 0, m.stack[a].backViewId = m.stack[a].forwardViewId = null) : delete D.views[m.stack[a].viewId];
                        m.stack = [D.views[R]]
                    }
                    w = null
                }
                if (p(R), D.backView && z == D.backView.historyId && u == D.backView.stateId && O == D.backView.url)for (a = 0; a < m.stack.length; a++)if (m.stack[a].viewId == R) {
                    M = "dupNav", H = V, a > 0 && (m.stack[a - 1].forwardViewId = null), D.forwardView = null, D.currentView.index = D.backView.index, D.currentView.backViewId = D.backView.backViewId, D.backView = s(D.backView), m.stack.splice(a, 1);
                    break
                }
            ...
            create: function (t, d, v, T, E, _) {
                var N, R, M, H = ++A, z = {
                    init: function (e, t) {
                        ...
                        for (n = 0, i = r.length; i > n && (o = r.eq(n), o.data(y) === c ? o.data(w) ? (o.data(y, c + ionic.Utils.nextUid()), o.data(b, !0)) : N = o : f(s) && o.data(y) === s && (R = o), !N || !R); n++);
                        M = !!N, M || (N = e.ele || L.createViewEle(d), N.data(y, c)), _ && t.activeEleId(c), e.ele = null
                    }, render: function (e, n) {
                        if (M)ionic.Utils.reconnectScope(N.scope()); else {
                            h(N, x);
                        ...
                        function p() {
                            h(N, W.shouldAnimate ? "entering" : B), h(R, W.shouldAnimate ? "leaving" : I), W.run(1), r._instances.forEach(function (e) {
                        ...
                        function b() {
                            b.x || (b.x = !0, N.off($, w), e.cancel(N.data(k)), R && e.cancel(R.data(k)), z.emit("after", O, U), C && C.resolve(t), H === A && (n.all(P).then(L.transitionEnd), z.cleanup(O)), r._instances.forEach(function (e) {
                        ...
                        function S() {
                            h(N, I), h(R, B), N.off($, y), e.cancel(N.data(k)), L.transitionEnd([t])
                        }

                        var C, O = s(d, N, a, v), U = u(u({}, O), l(T));
                        O.transitionId = U.transitionId = H, O.fromCache = !!M, O.enableBack = !!c, O.renderStart = E, O.renderEnd = _, V(N.parent(), "nav-view-transition", O.transition), V(N.parent(), "nav-view-direction", O.direction), e.cancel(N.data(k));
                        var q = o.transitions.views[O.transition] || o.transitions.views.none, W = q(N, R, O.direction, O.shouldAnimate && f && _);
                        if (W.shouldAnimate && (N.on($, w), N.data(k, e(b, D)), i.show(D)), E && (z.emit("before", O, U), h(N, x), W.run(0)), _ && (C = n.defer(), P.push(C.promise)), E && _)e(p, 16); else {
                            if (!_)return h(N, "entering"), h(R, "leaving"), {
                                run: W.run, cancel: function (t) {
                                    t ? (N.on($, y), N.data(k, e(S, D)), i.show(D)) : S(), W.shouldAnimate = t, W.run(0), W = null
                                }
                            };
                            _ && p()
                        }
                        ...
                        var i = N.scope();
                        i && (i.$emit("$ionicView." + e + "Enter", t), "after" == e && i.$emit("$ionicView.enter", t)), R ? (i = R.scope(), i && (i.$emit("$ionicView." + e + "Leave", n), "after" == e && i.$emit("$ionicView.leave", n))) : i && n && n.viewId && (i.$emit("$ionicNavView." + e + "Leave", n), "after" == e && i.$emit("$ionicNavView.leave", n))
                    }, cleanup: function (e) {
                        R && "back" == e.direction && !o.views.forwardCache() && p(R);
            ...
            restrict: "E", require: "^?ionNavView", scope: !0, priority: 800, compile: function (e, o) {
                function r(e, r, c) {
                    ...
                    if (e.$watch(function () {
                        ...
                        var l = {};
                        "true" !== o.overflowScroll && i.scrolling.jsScrolling() ? l = {
                            el: r[0],
                            ...
                            l && (l.scrollingComplete = g, delete l.el), a = null, r = null, o.$$element = null
                        })
                    }
                }
