...
CREATE TABLE ads (id INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, userid INT UNSIGNED NOT NULL, title VARCHAR(100) NOT NULL, description VARCHAR(250) NOT NULL, category TINYINT UNSIGNED NOT NULL, radius FLOAT NOT NULL, lat MEDIUMINT NOT NULL, lon MEDIUMINT NOT NULL, date_created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, date_expires TIMESTAMP NOT NULL); //

drop table if exists proposals //

CREATE TABLE proposals (id INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, userid INT UNSIGNED NOT NULL, adid INT UNSIGNED NOT NULL, lat MEDIUMINT NOT NULL, lon MEDIUMINT NOT NULL, date_created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP); //
